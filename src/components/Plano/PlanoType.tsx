...
const planosArray = [
  {
    ...
    hireApiType: PlanoHireApiReference.AGGILIZADOR,
    key: `Plano Aggilizador1`,
    title: {
...
export type PlanoEditableContent =
  | TextEditableContent
  | 'description'
  | 'licenceQuantity';
...
export const isEditablePlanoType = (data: any): data is PlanoContent => {
  return !!(data.texts && data.planos && data.planos.length > 0);
};
